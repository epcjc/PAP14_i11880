...
function Delete_Confirm()
	{
	var agree1=confirm("Tem a certeza que deseja eliminar o registo?\Esta opera��o n�o tem retorno.");
	if (agree1)
		return true ;
	else
		return false ;
...
<table width="600" height="300" border="0" align="center" cellpadding="8" cellspacing="1" background="../imgs/bk-title.gif">
  <tr>
    <td align="center" valign="top"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="200"><span class="white"><img src="logodias.png" alt="" ></span></td>
	...
	?>
          ...
          <table width="100%" border="1" cellpadding="4" cellspacing="0" bordercolor="#CCCCCC">
            ...
            <tr>
              <td align="center" class="white">Profissão</td>
